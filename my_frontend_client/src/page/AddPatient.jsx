...
export default function () {
  ...
  return <Card className="p-3" style={{ boxShadow: "0 0.1rem 1.5rem rgba(0, 0, 0, 0.4)" }}>
    ...
    <div className="d-flex justify-content-center" style={{ width: "100%" }}>
      <Button className="mt-2 mb-2" disabled={!localStorage.getItem("my_jwt_token") || !(newPatient.name && newPatient.sex && newPatient.age && newPatient.address && newPatient.payment && newPatient.balance)} onClick={onAddPatientClick}>
